...
const navigation = [
  ...
  { name: 'Classes', href: '/classes', icon: ClassIcon },
  { name: 'Subjects', href: '/subjects', icon: SubjectIcon },
  { name: 'Chapters', href: '/chapters', icon: ChapterIcon },
];
      ...
      <aside className="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="font-bold text-lg">Academ</span>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-500">Curriculum Management</span>
          </div>
        </header>
